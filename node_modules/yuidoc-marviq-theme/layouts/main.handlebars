...
<head>
    ...
    <link rel="stylesheet" href="{{projectAssets}}/vendor/bootstrap/css/bootstrap-responsive.css">
    <link rel="stylesheet" href="{{projectAssets}}/css/marviq.css">
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        ...
        {{projectName}}
            ...
            <li>
                <img alt="{{projectName}}" src="{{projectAssets}}/img/logo.png" style="margin-top: 7px; margin-left: 25px; max-height: 30px" title="{{projectName}}" />
            </li>
