...
function main() {
	...
	if(params !== 'undefined'){
		myFVGA.popSize = parseInt(jsEOUtils.getInputParam("popSize", params.Poblation));
		myFVGA.tournamentSize = parseInt(jsEOUtils.getInputParam("tournamentSize", 2));
		myFVGA.xOverRate = parseFloat(jsEOUtils.getInputParam("xOverRate", params.CrossOver));
		myFVGA.mutRate = parseFloat(jsEOUtils.getInputParam("mutRate", params.Mutation));
		...
		myFVGA.numGenerations = parseInt(jsEOUtils.getInputParam("numGenerations", params.Generations));
		myFVGA.replaceRate = parseFloat(jsEOUtils.getInputParam("replaceRate", 0.5));
		myFVGA.showing = parseInt(jsEOUtils.getInputParam("showing", 5));
