...
function main() {
	...
	if(params !== 'undefined'){
		myBSGA.popSize = jsEOUtils.getInputParam("popSize", params.Poblation);
		myBSGA.tournamentSize = jsEOUtils.getInputParam("tournamentSize", 2);
		myBSGA.xOverRate = jsEOUtils.getInputParam("xOverRate", params.CrossOver);
		myBSGA.mutRate = jsEOUtils.getInputParam("mutRate", params.Mutation);
		...
		myBSGA.numGenerations = jsEOUtils.getInputParam("numGenerations", params.Generations);
		myBSGA.replaceRate = jsEOUtils.getInputParam("replaceRate", 0.5);
		myBSGA.showing = jsEOUtils.getInputParam("showing", 5);
