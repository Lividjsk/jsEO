...
/**
* Algorithm for Representation Order
*
* @class jsEOROGA
*/
var jsEOROGA = new Class({
    Extends: jsEOGA,
    /**
	...
	*/
    ...
    run: function(_fitFn) {
        ...
        jsEOUtils.showPopTSP(this.population, "Población Inicial", this.showing, "ipop");
        ...
        jsEOUtils.showPopTSP(this.population, "Población Final", this.showing, "fpop");
		...
		//jsEOUtils.saveInformation("TSP", this.popSize, this.numGenerations, (endTime-startTime), fitnessInit, fitnessFin);
    }
