...
var jsEOFVGA = new Class({
	...
	*/
     ...
     * @method run
     * @param {Integer} _fitFn Fitness of the individual
     * @return null
     */
    run: function(_fitFn) {
        // Program
        ...
        jsEOUtils.showPop(this.population, "Población Inicial", this.showing, "ipop");
		...
		//jsEOUtils.saveInformation("TSP", this.popSize, this.numGenerations, (endTime-startTime));
		jsEOUtils.drawFitness(popInit, popFin);
		jsEOUtils.showTime((endTime-startTime), "time")
		jsEOUtils.showDescription("Float", "title");
        jsEOUtils.showPop(this.population, "Población Final", this.showing, "fpop");
